...
phase 1: In phase1 we have use scrapy to login a website and scrap all the forms in the target website.
===================================================================================================
phase 2: In phase2 we have prepare a set of possile input types and its value, formed a dictions to be used later for fill in the form for attack. 

The phase2 output can be generated seperated using below command:

python phase2.py
===================================================================================================
phase 3: In phase3, the form first is filtered use keywords. This is to filter the form which data is definitely not sensitive. And the form is filled in and posted to the website. If the response status code is 200, the cross site request is successfully made which means the form is vulnerable to CSRF attack. the form is recorded in phase3.json for later use.

The phase3 output can be generated by 1st getting phase1.json and put in same directory,
